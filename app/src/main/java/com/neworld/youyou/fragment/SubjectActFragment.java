...
public class SubjectActFragment extends BaseFragment {
    ...
    public View createView() {
        View view = View.inflate(context, R.layout.subject_act, null);
                        ...
                        public void run() {
                            if (mDatas != null && mDatas.size() > 0) {
                                ...
                                if (!TextUtils.isEmpty(createDate)) {
                                    String nmsl = Base64.encodeToString(("{\"type\":\"4\", \"CreateDate\":\"" + createDate + "\"}").getBytes(), Base64.DEFAULT);
    ...
    public Object getData() {
        String base64 = Base64.encodeToString(("{\"type\":\"4\", \"CreateDate\":\"\"}").getBytes(), Base64.DEFAULT);
