...
public class SubjectChineseFragment extends BaseFragment {
    ...
    public View createView() {
        View view = View.inflate(context, R.layout.subject_chinese, null);
                        ...
                        public void run() {
                            if (mDatas != null && mDatas.size() > 0) {
                                ...
                                if (!TextUtils.isEmpty(createDate)) {
                                    String nmsl = Base64.encodeToString(("{\"type\":\"2\", \"CreateDate\":\"" + createDate + "\"}").getBytes(), Base64.DEFAULT);
    ...
    public Object getData() {
        String base64 = Base64.encodeToString(("{\"type\":\"2\", \"CreateDate\":\"\"}").getBytes(), Base64.DEFAULT);
