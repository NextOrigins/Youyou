...
public class HotMiddleFragment extends BaseFragment {
    ...
    public View createView() {
        View view = View.inflate(context, R.layout.hot_middle, null);
...
//        hotEveryAdapter = initAdapter(hotEveryAdapter);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (createDate != null && createDate.length() > 0) {
                                String base64 = Base64.encodeToString(("{\"createDate\": \""+createDate+"\",\"type\": \"6\",\"userId\": \""+userId+"\"}").getBytes(), Base64.DEFAULT);
    ...
    public Object getData() {
        String base64 = Base64.encodeToString(("{\"createDate\": \"\",\"type\": \"6\",\"userId\": \""+userId+"\"}").getBytes(), Base64.DEFAULT);
        String replace = base64.replace("\n", "");
        String content = NetManager.getInstance().getContent(replace, "131");
