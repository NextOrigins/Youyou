 ...
 */
  public class SlideView extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
         ...
         */
        SlideView slideDelete = SlideDeleteManager.getInstance().getSlideDelete();
    ...
    static class SlideDeleteManager {
        private SlideView mSlideDelete;
        ...
        public SlideView getSlideDelete() {
            return mSlideDelete;
        }

        public void setSlideDelete(SlideView slideDelete) {
