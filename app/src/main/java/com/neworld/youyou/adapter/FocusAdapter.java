...
public class FocusAdapter extends BaseAdapter {
    ...
    public FocusAdapter(Context focusActivity, ArrayList<FocusBean.MenuListBean> allList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ContentViewHolder holder1 = null;
        if (convertView == null) {
            holder1 = new ContentViewHolder();
            ...
            holder1 = (ContentViewHolder) convertView.getTag();
        }
        ...
        holder1.ivAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onFocusClick.onItemAdd(position);
            }
        });
    ...
    private void showItemData(ArrayList<FocusBean.MenuListBean> newList, ContentViewHolder holder1, int position) {
    ...
    private OnFocusClick onFocusClick;
