...
import com.neworld.youyou.select.ImagePagerAdapter;
import com.neworld.youyou.select.MyViewPager;

import java.util.ArrayList;

import static android.animation.ObjectAnimator.ofFloat;

public class PreviewPublishActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images,
        ...
        Intent intent = new Intent(activity, PreviewPublishActivity.class);
