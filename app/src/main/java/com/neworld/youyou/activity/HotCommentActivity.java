...
public class HotCommentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initUser() {
        userId = Sputil.getString(HotCommentActivity.this, "userId", "");
    ...
    private void dialogPublish() {
        final AlertDialog.Builder ad=new AlertDialog.Builder(HotCommentActivity.this);
            ...
            if (!TextUtils.isEmpty(userId) && !TextUtils.isEmpty(taskId)) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String result = NetManager.getInstance().getContent(replace, "134");
